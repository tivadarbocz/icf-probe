...
public class ContentEditorView extends Div implements BeforeEnterObserver {

    private final H2 h2RandomText1 = new H2();

    public ContentEditorView() {
        final WrapperCard wrapperCard = BadgeUtil.createBadge("Content editor view", h2RandomText1, "primary-text", LoremIpsum.getInstance().getWords(1, 5), "badge");
